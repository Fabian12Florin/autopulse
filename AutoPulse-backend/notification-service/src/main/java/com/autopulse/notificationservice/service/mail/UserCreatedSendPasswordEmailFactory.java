...
@Component
public class UserCreatedSendPasswordEmailFactory {

    private static final String SUBJECT = "Welcome to AutoPulse - Your temporary password";
    ...
    public UserCreatedSendPasswordEmailFactory(
    ...
    public EmailMessage build(UserCreatedSendPasswordEvent event) {
        ...
        String contentHtml = templateEmailRenderer.render("emails/user-created-send-password", contentModel);
